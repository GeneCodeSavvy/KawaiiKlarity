...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex items-center justify-center w-10 h-10 rounded-lg border border-primary/20 hover:border-primary/40 transition-colors group"
